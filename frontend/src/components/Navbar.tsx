...
const Navbar = () => {
  ...
  const { user, loading, checkUser, isLoggedIn } = useAuth();
  ...
  return loading ? (
    ...
    <>
      ...
      <nav
        ...
        className={`w-full px-4 sm:px-6 lg:px-8 py-4 text-white flex justify-between items-center shadow-lg`}
      >
        {/* LOGO */}
          ...
          <div className="hidden md:flex items-center gap-6">
            {viewerNavbar.navbaroption.map((val, i) => (
              <NavLink
                key={i}
                to={val.location}
                className="text-base lg:text-lg hover:text-yellow-400 transition-colors"
              >
                {val.name}
              </NavLink>
            ))}
            ...
            <Link
              to={user?.role=="admin"?"/admin-dashboard":"/creator-dashboard"}
              ...
              {isLoggedIn && (
                <>
                  ...
                  <div className="w-full space-y-2">
                    <button className="w-full px-4 sm:px-6 py-2 sm:py-2.5 bg-gray-700 hover:bg-gray-600 rounded-lg text-white text-sm sm:text-base font-medium transition-all duration-200">
                      Edit Profile
                    </button>
              ...
              <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-12 items-start">
                ...
                <div className="lg:col-span-6 space-y-6">
                  ...
                  <div className="flex flex-col gap-4">
                    ...
                    {isLoggedIn && (
                      <button
                        className="w-full text-left px-6 py-4 bg-red-600 hover:bg-red-500 rounded-lg text-lg sm:text-xl transition-all duration-200 transform hover:scale-105"
                        onClick={logoutUser}
                      >
                        Logout
                      </button>
